  ...
  <path fillRule="evenodd" d="M5.47 5.47a.75.75 0 0 1 1.06 0L12 10.94l5.47-5.47a.75.75 0 1 1 1.06 1.06L13.06 12l5.47 5.47a.75.75 0 1 1-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 0 1-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
                ...
                <div className="mt-4">
                    ...
                    <div className="flex justify-between items-center">
                        <label>
                            <input type="radio" name="size" value="Small" checked={selectedSize === "Small"} onChange={() => setSelectedSize('Small')} />
                            Small
                        </label>
                        <label>
                            <input type="radio" name="size" value="Medium" checked={selectedSize === "Medium"} onChange={() => setSelectedSize("Medium")}/>
                            Medium
                        </label>
                        <label>
                ...
                <button className="block mx-auto mt-4 bg-primaryTem2 text-white rounded-full px-8 py-2" onClick={() => {
