      ...
      try {
        ...
        if (itemRes.ok) {
          ...
          const category = allCategories.find(
            (cat: Category) => cat.id === itemData.categoryId
          );
          if (category) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex justify-center">
        <form
          className="mt-8 max-w-2xl w-full  p-8 rounded-lg shadow-lg"
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-2 block w-full p-2.5 border rounded-lg text-gray-700 focus:ring-red-500 focus:border-red-500 outline-none transition"
